...
public class LoginPage extends BasePage {
    ...
    public WebElement getUserErrorWindow() {
        return getDriver().findElement(userErrorWindow);
    }

    public WebElement getPasswordErrorWindow() {
        return getDriver().findElement(passwordErrorWindow);
    }
